...
# Specify the initialisation band settings.
...
# Specify the initialisation parameter settings.
# Specify the Inertia values.
high_inertia = 1000.0
mid_inertia = 500.0
low_inertia = 250.0
# Specify the transformation parameters.
# The inertia tail values.
theta_i1 = 0.030
theta_i2 = theta_i1*0.1
# The conversion point values.
theta_cp = 0.020
# The conversion tail values.
theta_c1 = 0.005
...
# Save the rules generated.
initial_rules_file = output_path + case_study + "\\Rules\\rules.csv"
store = [0] * 6
...
# Now, evaluate the rule-set generated.
...
# Iteratively test the simulation over a number of model runs.
run_count = 0
...
metrics_output_file = output_path + "\\" + case_study + "\\final_metrics.csv"
store = [0]*(5 + luc)
