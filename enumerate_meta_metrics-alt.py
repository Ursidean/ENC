...
case_studies = ["Berlin"]#["Berlin", "Budapest", "Madrid", "Rome"]
...
for a in range(0, len(case_studies)):
    ...
    while run_count < max_runs:
        ...
        it_clu = area_weighted_clu_error(map3, smap, mask, luc, pas, act, luc_count)
...
metrics_output_file = output_path + case_study + "\\meta_metrics-default.csv"
store = [0]*6
with open (metrics_output_file, "wb") as csv_file:
    writer = csv.writer(csv_file)
    values = ["Case study", "Year", "Seed", "Kappa", "KSIM", "AAWCE"]
