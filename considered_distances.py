...
def considered_distances(max_distance):
    ...
    distances.sort()
    # The minimum distance (0) is added to the list (note: not included due to double-count error)
    distances = [0] + distances
    # The length of distances is determined, specifying the number of distances to be considered.
    cdl = len(distances)
